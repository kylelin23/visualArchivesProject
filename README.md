...
The Visual Archives Project is a website built with React using a Vite framework with the purpose of displaying data for the visual archives. The data contains information such as the measurements of the archives. 
